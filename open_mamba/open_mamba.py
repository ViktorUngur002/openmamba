...
class OpenMamba(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            open_mamba: open_mamba module will extract the high-level guidance maps
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            "train_maft": cfg.MODEL.OPEN_MAMBA.TRAIN_MAFT,
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            high_level_guidance_masks = self.open_mamba(clip_vis_dense, masks, text_features, self.training)
            
            maps_for_pooling = F.interpolate(high_level_guidance_masks, size=clip_feature.shape[-2:],
            ...
            outputs = self.open_mamba(clip_vis_dense, masks, text_features, self.training)
