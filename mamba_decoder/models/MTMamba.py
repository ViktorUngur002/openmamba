...
# Reference: https://github.com/EnVision-Research/MTMamba

INTERPOLATE_MODE = 'bilinear'

class MTMamba(nn.Module):
    def __init__(self, d_state=16, dt_rank="auto", ssm_ratio=2, mlp_ratio=0):
        super().__init__()
        self.tasks = ['include_semseg']
        self.feature_channel = [48,96,192,384]
        self.img_size = 32
        ...
        for t in self.tasks:
            ...
            self.final_project[t] = nn.Conv2d(self.feature_channel[0], 384, 1, 1, 0, bias=True)
